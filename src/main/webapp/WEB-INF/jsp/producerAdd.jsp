...
<div class="layui-fluid">
    <div class="layui-row">
        <form>
            ...
            <input type="hidden" id="producerId" name="producerId" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label for="address" class="layui-form-label">
            <span class="x-red">*</span>生产商地址</label>
        <div class="layui-input-inline layui-show-xs-block layui-form">
            <input type="text" id="address" name="address" required="" lay-verify="phone" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    function save(){
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/gc/insertProSave.ajax",
            dataType:"text",
            data:$("form").serialize(),
