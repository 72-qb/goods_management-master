...
<div class="layui-fluid">
    <div class="layui-row">
        <form>
            ...
            <input type="hidden" id="typeId" name="typeId" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
    <div class="layui-form-item">
        <label for="name" class="layui-form-label">
            <span class="x-red">*</span>商品类型名称</label>
        <div class="layui-input-inline">
...
<script>
    ...
    function save(){
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/gc/insertTypeSave.ajax",
            dataType:"text",
            data:$("form").serialize(),
